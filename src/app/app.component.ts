...
export class MyApp {
  ...
  constructor(//private admob: AdMobPro, private fcm: FCM, 
    public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen, public storage: Storage, public globalVariables: GlobalVariablesProvider) {
    this.initializeApp();

    // used for an example of ngFor and navigation
    this.pages = [
      { title: 'Upload', component: UploadeventPage, icon: 'add' },
      { title: 'About US', component: AboutusPage, icon: 'people' },
